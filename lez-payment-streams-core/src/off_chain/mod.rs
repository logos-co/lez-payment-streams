...
pub use canonical::{
    ...
    store_eligibility_canonical_payload_digest_from_n8_wire, vault_owner_auth_canonical_payload,
    vault_owner_auth_canonical_payload_digest, CanonicalStoreQueryParts,
    VaultOwnerAuthCanonicalError, N8_REFERENCE_CONTENT_TOPIC, N8_REFERENCE_PUBSUB_TOPIC,
    N8_REFERENCE_STORE_ELIGIBILITY_WIRE_LEN,
};
pub use constants::{
...
pub use proofs::{
    ...
    verify_stream_proposal_vault_proof, verify_stream_proposal_vault_proof_for_token,
    verify_stream_proposal_vault_signature,
};
pub use protobuf::{
