...
| Deterministic demo lifecycle (fresh stream, explicit prepare id) | 24c complete — [step-24c-simplify-demo-flow.md](docs/plan/completed/step-24c-simplify-demo-flow.md) |
