...
### Step 22, User Journey — UI doc packet
...
only** through the `payment_streams_ui` plugin — vaults, streams, accrual, optional claim.
...
- Published User Journey doc; Red Team when required by release milestone.
