...
Steps 1–13, 11d, and Step 14 (Store wire on `logos-delivery`) are complete. Implement next:
...
`feat/payment-streams-store-eligibility`. Steps 14–15 on the Nim repo, Step 16 on the module
with flake input aligned to that fork. Summary:
...
| Task | Files (in order) |
| --- | --- |
| Delivery / Store wire (15–16) | This brief → [integration-contracts.md](integration-contracts.md) → step packet → [D1](reference/decisions-and-notes.md#d1-store-wire-format) / [D2](reference/decisions-and-notes.md#d2-delivery-module-hook-design). Step 14 wire: [step-14-normative.md](plan/completed/step-14-normative.md). |
...
- [plan/completed/step-12-normative.md](plan/completed/step-12-normative.md), [step-13-normative.md](plan/completed/step-13-normative.md), [step-14-normative.md](plan/completed/step-14-normative.md)
