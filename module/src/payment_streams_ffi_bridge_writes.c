...
uint32_t ps_ffi_fixed_clock_10_account_id(uint8_t out_account_id_bytes[32]) {
    // Soft-path default remains CLOCK_01 (misnamed; matches fixtures RWNU).
    return ps_ffi_fixed_clock_account_id(
...
uint32_t ps_ffi_fixed_clock_account_id(uint32_t selector, uint8_t out_account_id_bytes[32]) {
    return map_status(payment_streams_ffi_fixed_clock_account_id(
        (PaymentStreamsFfiClockAccountChoice)selector, out_account_id_bytes));
}
...
uint32_t ps_ffi_serialize_withdraw_to_owner(uint64_t vault_id,
                                            ...
                                            size_t out_cap,
                                            size_t* out_len) {
    return map_status(payment_streams_ffi_serialize_withdraw_to_owner_instruction(
        vault_id, amount_lo, amount_hi, out_ptr, out_cap, out_len));
}
...
uint32_t ps_ffi_plan_withdraw_to_owner(const uint8_t program_id_bytes[32],
                                       ...
                                       size_t accounts_hex_out_cap,
                                       size_t* accounts_hex_out_len) {
    return map_status(payment_streams_ffi_plan_withdraw_to_owner_instruction_accounts(
        program_id_bytes,
        owner_account_id_bytes,
        vault_id,
        accounts_hex_out,
...
uint32_t ps_ffi_serialize_close_stream_by_owner(uint64_t vault_id,
                                                ...
                                                size_t out_cap,
                                                size_t* out_len) {
    return map_status(payment_streams_ffi_serialize_close_stream_by_owner_instruction(
        vault_id, stream_id, out_ptr, out_cap, out_len));
}
...
uint32_t ps_ffi_plan_close_stream_by_owner(const uint8_t program_id_bytes[32],
                                           ...
                                           size_t accounts_hex_out_cap,
                                           size_t* accounts_hex_out_len) {
    return map_status(payment_streams_ffi_plan_close_stream_by_owner_instruction_accounts(
        program_id_bytes,
        owner_account_id_bytes,
        vault_id,
        stream_id,
...
uint32_t ps_ffi_serialize_close_stream_by_provider(uint64_t vault_id,
                                                   ...
                                                   size_t out_cap,
                                                   size_t* out_len) {
    return map_status(payment_streams_ffi_serialize_close_stream_by_provider_instruction(
        vault_id, stream_id, out_ptr, out_cap, out_len));
}
...
uint32_t ps_ffi_plan_close_stream_by_provider(const uint8_t program_id_bytes[32],
                                              ...
                                              size_t accounts_hex_out_cap,
                                              size_t* accounts_hex_out_len) {
    return map_status(payment_streams_ffi_plan_close_stream_by_provider_instruction_accounts(
        program_id_bytes,
        owner_account_id_bytes,
        vault_id,
        stream_id,
