...
# shellcheck source=verify/testnet-common.sh
...
MANIFEST="${FIXTURE_MANIFEST:-$REPO_ROOT/verify/fixtures/testnet.json}"
PROGRAM_ID_HEX="${TESTNET_PROGRAM_ID_HEX:-9d88f2e7498ae25caa3a5d829a3d1ed39f08673ba90987333074b965a81b90f8}"
