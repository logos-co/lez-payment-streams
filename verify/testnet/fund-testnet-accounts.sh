...
#   OWNER_TARGET=700 PROVIDER_MIN=100 ./verify/testnet/fund-testnet-accounts.sh
#   OWNER=<base58> PROVIDER=<base58> ./verify/testnet/fund-testnet-accounts.sh
set -euo pipefail
...
FIXTURE="$REPO_ROOT/verify/fixtures/testnet-module.json"
