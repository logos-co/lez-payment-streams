...
MANIFEST="${FIXTURE_MANIFEST:-verify/fixtures/localnet.json}"
FORCE="${SEED_FORCE:-0}"
...
"$REPO_ROOT/verify/lib/ensure-scaffold-lez-layout.sh"
...
PROVIDER_FILE=".scaffold/.lez_payment_streams-fixture-provider"
...
cargo run --quiet --manifest-path verify/seed/Cargo.toml --bin seed_localnet_fixture -- seed-onchain \
